...
<section id="form" class="pb-6">
	<div class="max-w-2xl mx-auto px-3 md:px-0">
		<h1 class="text-2xl font-semibold text-gray-700 py-6">BizzFit</h1>
		<p class="text-lg mb-2">Vul hier de gegevens in van je activiteit!</p>
		<div class="border rounded-lg p-4 bg-gray-50">
			<form on:submit|preventDefault={() => true} action="" class="space-y-5" data-netlify="true" name="activity-form">
