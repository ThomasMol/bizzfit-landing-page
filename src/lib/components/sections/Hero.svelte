...
<section id="hero">
	<div class="container mx-auto lg:flex px-4 lg:px-16">
		<div class="flex-1 basis-1/2 py-8 lg:py-20 text-center lg:text-left">
			<h1 class="mb-3 text-4xl font-semibold">Begin met BizzFit</h1>
			<h2 class="mb-5 text-2xl font-semibold text-orange-400">
			...
			<div class="flex flex-wrap gap-4 md:gap-8">
				<div class="text-center mx-auto">
					...
					<a
						href="/#contact"
						class="rounded bg-orange-400 w-full py-2 px-8 text-xl font-semibold text-zinc-100 no-underline hover:bg-orange-500 hover:text-zinc-50"
						>Beveel ons aan</a>
				</div>
				<div class="text-center mx-auto">
					...
					<a
						href="/#contact"
						class="rounded border border-orange-400 py-2 px-8 text-xl font-semibold text-orange-400 no-underline hover:bg-orange-500 hover:text-zinc-50"
						>Plan een demo</a>
				</div>
			</div>
		</div>
